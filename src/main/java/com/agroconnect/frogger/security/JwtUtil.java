...
//
//    private final String SECRET_KEY = "secret"; // Later, use environment variable for production!
//
//    // Generate token based on user
//    public String generateToken(User user) {
//        return Jwts.builder()
//                .setSubject(user.getEmail())  // << HERE — using email
...
//        final String username = extractUsername(token); // really it's email
